        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: "20px", padding: "20px", fontWeight: "500" }}>
               مبانی الکترونیک یکی از مهمترین قسمت های  پیش نیازی تعمیرات موبایل هست
        ...
        >
          <Accordion>
            ...
            >
              ...
              >
                <div className="acordianHeader">
                  <div className="textHeaderAcordian">انواع برد الکترونیکی</div>
                  <div></div>
                </div>
              </Accordion.Header>
            ...
            <Accordion.Item className="AccordionItem" eventKey="1">
              ...
              >
                <div className="acordianHeader">
                  <div className="textHeaderAcordian">خازن</div>
                  <div></div>
                </div>
              </Accordion.Header>
              <Accordion.Body>فعلا آیتمی ندارد</Accordion.Body>
            ...
            <Accordion.Item className="AccordionItem" eventKey="2">
              ...
              >
                <div className="acordianHeader">
                  <div className="textHeaderAcordian">مقاومت</div>
                  <div></div>
                </div>
              </Accordion.Header>
              <Accordion.Body>فعلا آیتمی ندارد</Accordion.Body>
            ...
            <Accordion.Item className="AccordionItem" eventKey="3">
              ...
              >
                <div className="acordianHeader">
                  <div className="textHeaderAcordian">دیود</div>
                  <div></div>
                </div>
              </Accordion.Header>
              <Accordion.Body>فعلا آیتمی ندارد</Accordion.Body>
            ...
            <Accordion.Item className="AccordionItem" eventKey="4">
              ...
              >
                <div className="acordianHeader">
                  <div className="textHeaderAcordian">ترانزیستور</div>
                  <div></div>
                </div>
              </Accordion.Header>
            ...
            <Accordion.Item className="AccordionItem" eventKey="18">
              ...
              >
                <div className="acordianHeader">
                  <div className="textHeaderAcordian">سلف</div>
                  <div></div>
                </div>
              </Accordion.Header>
              <Accordion.Body>فعلا ایتمی ندارد</Accordion.Body>
